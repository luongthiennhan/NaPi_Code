  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      @foreach($row->getImage as $i)
        @if($i->image==NULL)
        <img class="mySlides" src="../resources/img/default.jpg">
        @else
        <img class="mySlides" src="../resources/{{ $i->image }}" alt="{{$row->name}}" >
        @endif
        @endforeach
  ...
  <div class="other-product">
    ...
    @foreach($array as $ar)
      ...
      <div class="view-overlay"> 
        ...
        @else
        <img class="image" src="../resources/{{ $ar->image }}" alt="{{$ar->name}}" >
        @endif
