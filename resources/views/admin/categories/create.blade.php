...
<body>
  <h3>Create New Category</h3>
    ...
    <div class="row">
        ...
        <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Please Enter Description..." value="{{old('quantity')}}" required/>
        </div>
    </div>
